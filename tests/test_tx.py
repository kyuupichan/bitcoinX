...
def test_repr():
    ...
    assert repr(tx) == (
        ...
        '00000000000000000000", prev_idx=4294967295, script="0319c4082f626d67706f6f6c2e636f6d2'
        'f5473537148110d9e7fcc3cf74ee70c0200", sequence=4294967295)], outputs=[TxOutput(value='
        '1250005753, script="76a914db1aea84aad494d9f5b253327da23c4e51266c9388ac")], locktime=0)'
    )
