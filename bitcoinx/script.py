...
OP_0 = Ops.OP_0
OP_FALSE = Ops.OP_FALSE
OP_PUSHDATA1 = Ops.OP_PUSHDATA1
OP_PUSHDATA2 = Ops.OP_PUSHDATA2
OP_PUSHDATA4 = Ops.OP_PUSHDATA4
OP_1NEGATE = Ops.OP_1NEGATE
OP_RESERVED = Ops.OP_RESERVED
OP_1 = Ops.OP_1
OP_TRUE = Ops.OP_TRUE
OP_2 = Ops.OP_2
OP_3 = Ops.OP_3
...
OP_VER = Ops.OP_VER
OP_IF = Ops.OP_IF
OP_NOTIF = Ops.OP_NOTIF
OP_VERIF = Ops.OP_VERIF
OP_VERNOTIF = Ops.OP_VERNOTIF
OP_ELSE = Ops.OP_ELSE
OP_ENDIF = Ops.OP_ENDIF
OP_VERIFY = Ops.OP_VERIFY
OP_RETURN = Ops.OP_RETURN
OP_TOALTSTACK = Ops.OP_TOALTSTACK
OP_FROMALTSTACK = Ops.OP_FROMALTSTACK
OP_2DROP = Ops.OP_2DROP
OP_2DUP = Ops.OP_2DUP
OP_3DUP = Ops.OP_3DUP
OP_2OVER = Ops.OP_2OVER
OP_2ROT = Ops.OP_2ROT
OP_2SWAP = Ops.OP_2SWAP
OP_IFDUP = Ops.OP_IFDUP
OP_DEPTH = Ops.OP_DEPTH
OP_DROP = Ops.OP_DROP
OP_DUP = Ops.OP_DUP
OP_NIP = Ops.OP_NIP
OP_OVER = Ops.OP_OVER
...
OP_TUCK = Ops.OP_TUCK
OP_CAT = Ops.OP_CAT
OP_SPLIT = Ops.OP_SPLIT
OP_NUM2BIN = Ops.OP_NUM2BIN
OP_BIN2NUM = Ops.OP_BIN2NUM
OP_SIZE = Ops.OP_SIZE
OP_INVERT = Ops.OP_INVERT
OP_AND = Ops.OP_AND
OP_OR = Ops.OP_OR
OP_XOR = Ops.OP_XOR
OP_EQUAL = Ops.OP_EQUAL
OP_EQUALVERIFY = Ops.OP_EQUALVERIFY
OP_RESERVED1 = Ops.OP_RESERVED1
OP_RESERVED2 = Ops.OP_RESERVED2
OP_1ADD = Ops.OP_1ADD
OP_1SUB = Ops.OP_1SUB
OP_2MUL = Ops.OP_2MUL
OP_2DIV = Ops.OP_2DIV
OP_NEGATE = Ops.OP_NEGATE
OP_ABS = Ops.OP_ABS
OP_NOT = Ops.OP_NOT
OP_0NOTEQUAL = Ops.OP_0NOTEQUAL
OP_ADD = Ops.OP_ADD
OP_SUB = Ops.OP_SUB
OP_MUL = Ops.OP_MUL
OP_DIV = Ops.OP_DIV
OP_MOD = Ops.OP_MOD
OP_LSHIFT = Ops.OP_LSHIFT
OP_RSHIFT = Ops.OP_RSHIFT
OP_BOOLAND = Ops.OP_BOOLAND
OP_BOOLOR = Ops.OP_BOOLOR
OP_NUMEQUAL = Ops.OP_NUMEQUAL
OP_NUMEQUALVERIFY = Ops.OP_NUMEQUALVERIFY
OP_NUMNOTEQUAL = Ops.OP_NUMNOTEQUAL
OP_LESSTHAN = Ops.OP_LESSTHAN
OP_GREATERTHAN = Ops.OP_GREATERTHAN
OP_LESSTHANOREQUAL = Ops.OP_LESSTHANOREQUAL
OP_GREATERTHANOREQUAL = Ops.OP_GREATERTHANOREQUAL
OP_MIN = Ops.OP_MIN
OP_MAX = Ops.OP_MAX
OP_WITHIN = Ops.OP_WITHIN
OP_RIPEMD160 = Ops.OP_RIPEMD160
OP_SHA1 = Ops.OP_SHA1
OP_SHA256 = Ops.OP_SHA256
OP_HASH160 = Ops.OP_HASH160
OP_HASH256 = Ops.OP_HASH256
OP_CODESEPARATOR = Ops.OP_CODESEPARATOR
OP_CHECKSIG = Ops.OP_CHECKSIG
OP_CHECKSIGVERIFY = Ops.OP_CHECKSIGVERIFY
OP_CHECKMULTISIG = Ops.OP_CHECKMULTISIG
OP_CHECKMULTISIGVERIFY = Ops.OP_CHECKMULTISIGVERIFY
OP_NOP1 = Ops.OP_NOP1
OP_CHECKLOCKTIMEVERIFY = Ops.OP_CHECKLOCKTIMEVERIFY
OP_NOP2 = Ops.OP_NOP2
OP_CHECKSEQUENCEVERIFY = Ops.OP_CHECKSEQUENCEVERIFY
OP_NOP3 = Ops.OP_NOP3
OP_NOP4 = Ops.OP_NOP4
OP_NOP5 = Ops.OP_NOP5
OP_NOP6 = Ops.OP_NOP6
...
OP_NOP8 = Ops.OP_NOP8
OP_NOP9 = Ops.OP_NOP9
OP_NOP10 = Ops.OP_NOP10

__all__ += tuple(Ops.__members__)
